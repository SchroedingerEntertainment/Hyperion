...
namespace SE.Hyperion.Desktop.Win32
{
    public enum VirtualKeyMap : int
    {
        ...
        /// <summary>
        /// The uCode parameter is a scan code and is translated into a virtual-key code that does not 
        /// distinguish between left- and right-hand keys. If there is no translation, the function returns 0
        /// </summary>
        MAPVK_VSC_TO_VK = 1,

        /// <summary>
        /// The uCode parameter is a virtual-key code and is translated into an unshifted character value in the 
        /// low order word of the return value. Dead keys (diacritics) are indicated by setting the top bit of the 
        ...
        /// <summary>
        /// Windows Vista and later: The uCode parameter is a virtual-key code and is translated into a scan code. If 
        /// it is a virtual-key code that does not distinguish between left- and right-hand keys, the left-hand scan code 
