...
{
    public enum WinEventHook : int
    {
        /// <summary>
        /// The range of WinEvent constant values specified by the Accessibility Interoperability 
        /// Alliance (AIA) for use across the industry
        /// </summary>
        ...
        /// control, and window object. Server applications send this event for their accessible objects. Before 
        /// sending the event for the parent object, servers must send it for all of an object's child objects. 
        /// Servers must ensure that all child objects are fully created and ready to accept IAccessible calls 
        /// from clients before the parent object sends this event. Because a parent object is created after 
        /// its child objects, clients must make sure that an object's parent has been created before calling 
        /// IAccessible::get_accParent, particularly if in-context hook functions are used
        /// </summary>
